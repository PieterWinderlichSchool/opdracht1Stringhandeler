	 ...
	 <body>
		...
		<div class="wrapper">
			...
			?><ul>
					...
					<li>String 3 is de concatenation van string 1 en string 2: <?php
									echo $string3 = $input1 . $input2;
								?>
					 		</li>
					<li>Zoeken naar spaties. Er zit een spatie op positie <?php
									echo strpos($string3, " ");?> </li>
									<li>Zoeken naar @. Er zit een @ op positie <?php
													echo strpos($string3, "@");?> </li>
